  ...
  <div>
    <div>
      <form>
        ...
        <input
          type="email"
          className="border-b-2 px-2 py-1 border-b-secondary-500 w-64 mb-4"
          required
        />
        ...
        <textarea
          type="text"
          rows={6}
          className="border-b-2 px-2 py-1 border-b-secondary-500 w-full mb-4"
          required
        />
        <div className="w-full flex justify-end">
          <Button title="Enviar correo" color="bg-secondary-700" />
        </div>
      </form>
    </div>
  </div>
